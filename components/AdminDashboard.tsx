            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    ...
                    <div className="lg:col-span-2 bg-white p-4 md:p-6 rounded-lg shadow-lg">
                         <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-bold text-inverland-dark">Rendimiento y Comisiones</h3>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {dashboardData.agentPerformance.map(agent => (
                                        <tr key={agent.id}>
                                            ...
                                            <td className="px-4 py-2 whitespace-nowrap text-sm font-bold text-inverland-green">{formatCurrency(agent.totalCommission)}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                ...
                <div className="mt-8">
                    <div className="bg-white p-4 md:p-6 rounded-lg shadow-lg">
                        <h3 className="text-lg font-bold text-inverland-dark mb-4 text-center">Detalle de Ventas y Comisiones</h3>
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                    ...
                                    {properties.filter(p => p.status === 'Sold').sort((a, b) => new Date(b.soldAt || '').getTime() - new Date(a.soldAt || '').getTime()).map(prop => {
                                        ...
                                        return (
                                            <tr key={prop.id}>
                                                ...
                                                <td className="px-4 py-2 whitespace-nowrap text-sm font-bold text-inverland-green">{formatCurrency(prop.commissionAmount || 0)}</td>
