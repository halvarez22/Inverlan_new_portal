                                ...
                                <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:hola@inverland.mx" className="text-gray-700 hover:text-inverland-green transition-colors duration-300">
                                                hola@inverland.mx
                                            </a>
                                        </div>
                                    </div>
                ...
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="tel:+524776670010" className="bg-white text-inverland-green font-bold px-8 py-4 rounded-lg hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105 shadow-lg">
                                Llamar Ahora
                            </a>
                            <a href="https://wa.me/524776670010" target="_blank" rel="noopener noreferrer" className="border-2 border-white text-white font-bold px-8 py-4 rounded-lg hover:bg-white hover:text-inverland-green transition-colors duration-300">
                                WhatsApp
                            </a>
                        </div>
                    </div>
