    ...
    return (
        ...
        >
            <div className="relative">
                ...
                <div className="absolute top-4 left-4 bg-inverland-green text-white px-3 py-1 text-sm font-semibold rounded-full">{t(`type.${property.type}`) || property.type}</div>
            ...
            <div className="container mx-auto px-4 sm:px-6">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <aside className="lg:col-span-1 bg-white p-4 md:p-6 rounded-lg shadow-lg self-start lg:sticky top-28">
                        <h3 className="text-2xl font-bold text-inverland-dark mb-6 border-b pb-4">{t('listings.filter_title') || 'Filtrar Propiedades'}</h3>
                        <div className="space-y-6">
                            ...
                            <button onClick={clearFilters} className="w-full text-center py-2 text-sm font-semibold text-inverland-blue hover:text-inverland-dark transition-colors">{t('listings.filter_clear') || 'Limpiar Filtros'}</button>
                        </div>
                    </aside>
